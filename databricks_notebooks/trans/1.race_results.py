...
# MAGIC %md
# MAGIC ##### Read all the data that is required
...
# MAGIC %md
# MAGIC ##### Join circuits dataframe to races dataframe
...
# MAGIC %md
# MAGIC ##### Join results dataframe to drivers, constructors and races dataframe
